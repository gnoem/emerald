const Avatar = ({ orientation, socketId }) => {
  return (
    <>
      {(orientation === 'N') && <AvatarS {...{ socketId }} />}
      {(orientation === 'NE') && <AvatarSW {...{ socketId }} />}
      {(orientation === 'NW') && <AvatarSE {...{ socketId }} />}
      {(orientation === 'S') && <AvatarS {...{ socketId }} />}
      {(orientation === 'SE') && <AvatarSE {...{ socketId }} />}
      {(orientation === 'SW') && <AvatarSW {...{ socketId }} />}
      {(orientation === 'E') && <AvatarE {...{ socketId }} />}
      {(orientation === 'W') && <AvatarW {...{ socketId }} />}
    </>
  );
}

const AvatarS = ({ socketId }) => {
  return (
    <svg viewBox="0 0 73.92 78.77">
      <defs>
        <linearGradient id={`${socketId}-linear-gradient`} x1="31.4" y1="53.77" x2="84.52" y2="53.77" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#005b97"/><stop offset="0.23" stopColor="#0075be"/><stop offset="0.6" stopColor="#1e9cd7"/><stop offset="1" stopColor="#cce0f4"/></linearGradient>
...
const AvatarSE = ({ socketId }) => {
  return (
    <svg viewBox="0 0 56.8 78.2">
      <defs>
        <linearGradient id={`${socketId}-linear-gradient`} x1="76.75" y1="61.32" x2="87.32" y2="61.32" gradientTransform="translate(6.53 -6.13) rotate(6)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#005b97"/><stop offset="0.23" stopColor="#0075be"/><stop offset="0.6" stopColor="#1e9cd7"/><stop offset="1" stopColor="#cce0f4"/></linearGradient>
        <linearGradient id={`${socketId}-linear-gradient-2`} x1="66.91" y1="85.05" x2="76.07" y2="85.05" xlinkHref={`#${socketId}-linear-gradient`}/>
        <linearGradient id={`${socketId}-linear-gradient-3`} x1="31.76" y1="53.82" x2="84" y2="53.82" gradientTransform="matrix(0.91, 0.1, -0.1, 0.99, 9.21, -5.85)" gradientUnits="userSpaceOnUse"><stop offset="0.19" stopColor="#005b97"/><stop offset="0.32" stopColor="#0075be"/><stop offset="0.6" stopColor="#1e9cd7"/><stop offset="1" stopColor="#cce0f4"/></linearGradient>
...
const AvatarSW = ({ socketId }) => {
  return (
    <svg viewBox="0 0 56.8 78.2">
      <defs>
        <linearGradient id={`${socketId}-linear-gradient`} x1="76.75" y1="61.32" x2="87.32" y2="61.32" gradientTransform="matrix(-0.99, 0.1, 0.1, 0.99, 110.23, -6.13)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#cce0f4"/><stop offset="0.4" stopColor="#1e9cd7"/><stop offset="0.77" stopColor="#0075be"/><stop offset="1" stopColor="#005b97"/></linearGradient>
        <linearGradient id={`${socketId}-linear-gradient-2`} x1="66.91" y1="85.05" x2="76.07" y2="85.05" xlinkHref={`#${socketId}-linear-gradient`}/>
        <linearGradient id={`${socketId}-linear-gradient-3`} x1="31.76" y1="53.82" x2="84" y2="53.82" gradientTransform="matrix(-0.91, 0.1, 0.1, 0.99, 107.55, -5.85)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#cce0f4"/><stop offset="0.4" stopColor="#1e9cd7"/><stop offset="0.68" stopColor="#0075be"/><stop offset="0.81" stopColor="#005b97"/></linearGradient>
        <linearGradient id={`${socketId}-linear-gradient-4`} x1="31.27" y1="70.34" x2="44.05" y2="70.34" xlinkHref={`#${socketId}-linear-gradient`}/>
        <linearGradient id={`${socketId}-linear-gradient-5`} x1="46.73" y1="91.11" x2="59.1" y2="91.11" xlinkHref={`#${socketId}-linear-gradient`}/>
      </defs>
...
const AvatarE = ({ socketId }) => {
  return (
    <svg viewBox="0 0 32.52 78.74">
      <defs>
        <linearGradient id={`${socketId}-linear-gradient`} x1="42" y1="53.77" x2="74.52" y2="53.77" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#005b97"/><stop offset="0.23" stopColor="#0075be"/><stop offset="0.6" stopColor="#1e9cd7"/><stop offset="1" stopColor="#cce0f4"/></linearGradient>
...
const AvatarW = ({ socketId }) => {
  return (
    <svg viewBox="0 0 32.52 78.74">
      <defs>
        <linearGradient id={`${socketId}-linear-gradient`} x1="42" y1="53.77" x2="74.52" y2="53.77" gradientTransform="matrix(-1, 0, 0, 1, 116.52, 0)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#cce0f4"/><stop offset="0.4" stopColor="#1e9cd7"/><stop offset="0.77" stopColor="#0075be"/><stop offset="1" stopColor="#005b97"/></linearGradient>
        <linearGradient id={`${socketId}-linear-gradient-2`} x1="51.67" y1="69.01" x2="63" y2="69.01" xlinkHref={`#${socketId}-linear-gradient`}/>
        <linearGradient id={`${socketId}-linear-gradient-3`} x1="51.99" y1="89.87" x2="65.07" y2="89.87" xlinkHref={`#${socketId}-linear-gradient`}/>
      </defs>
